        ...
        <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    <!--begin: Form -->
                    <!--begin::Form-->
                    <form class="m-form m-form--fit m-form--label-align-right" action="{{route('users.update', $user->UID)}}" method="post" accept-charset="UTF-8">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="text" class="form-control m-input" name="fullname"
                                           placeholder="Enter Full Name " data-toggle="m-tooltip" required value="{{$user->fullname}}">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="email" class="form-control m-input" name="email"
                                           placeholder="Enter Email " data-toggle="m-tooltip" required value="{{$user->email}}">
                                    <span class="m-form__help">
                                        Enter user's Name.
                                    </span>
                                </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="number" class="form-control m-input" name="phone"
                                           placeholder="Enter Phone " data-toggle="m-tooltip" value="{{$user->phone}}">
                                    <span class="m-form__help">
                                        Enter user's Phone.
                                    </span>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <input type="text" class="form-control m-input" name="address"
                                           placeholder="Enter Address " data-toggle="m-tooltip" value="{{$user->address}}">
                                    <span class="m-form__help">
