                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-row justify-content-between">
                                            <button data-toggle="modal" data-target="#m_modal_{{$event->ID}}" href="{{url('management/careers/' . $event->ID . '/delete')}}" type="button" class="btn  btn-danger mr-1">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                            <a href="{{url('management/careers/' . $event->ID . '/edit')}}" type="button" class="btn  btn-primary">
