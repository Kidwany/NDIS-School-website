...
var nmst = 10;
function goback(){
    nmst = document.getElementById("stepnum").value;
}
(function (e, t) {
    ...
    $.widget("kf." + wizard, {
        ...
        _state: function (stepIndex, stepsTaken) {
            ...
            for (; i < l; i++) {
                ...
                if (!state.stepIndex || state.stepIndex < stepIndex) {
                    ...
                    //find me here to backward

                    // switch(indexOfStep){
                    //     case 1:
                    //         document.getElementById("left_form").style.backgroundColor = "#da5b15";
                    //         document.getElementById("pic_info").innerHTML= "1";
                    //         break;
                    //     case 2:
                    //         document.getElementById("left_form").style.backgroundColor = "#1a9a47";
                    //         document.getElementById("pic_info").innerHTML= "2";
                    //         break;
                    //     case 3:
                    //         document.getElementById("left_form").style.backgroundColor = "#213f95";
                    //         document.getElementById("pic_info").innerHTML= "3";
                    //         break;
                    //     case 4:
                    //         document.getElementById("left_form").style.backgroundColor = "#e7cf39";
                    //         document.getElementById("pic_info").innerHTML= "4";
                    //         break;
                    //     case 5:
                    //         document.getElementById("left_form").style.backgroundColor = "#0e2a47";
                    //         document.getElementById("pic_info").innerHTML= "5";
                    //         break;
                    //     case 6:
                    //         document.getElementById("left_form").style.backgroundColor = "#1eacd6";
                    //         document.getElementById("pic_info").innerHTML= "6";
                    //         break;
                    //     case 7:
                    //
                    //         document.getElementById("left_form").style.backgroundColor = "#1a9a47";
                    //         document.getElementById("pic_info").innerHTML= "7";
                    //         break;
                    //
                    //
                    //     default:
                    //     //document.getElementById("left_form").style.backgroundColor = "#da5b15";
                    //     //document.getElementById("pic_info").innerHTML= "student";
                    // }
        ...
        _update: function (event, state) {
            ...
            if (current.step) {
                ...
                //after validation
                //alert(current.stepsActivated.length);
                //find me here to change photo
                //alert(current.stepsActivated.length);
                    ...
                    if (nmst <= 8)
                {
                    ...
                    document.getElementById("stepnum").value = parseInt(document.getElementById("stepnum").value) - 1;
                    nmst = document.getElementById("stepnum").value;
                    if(nmst == 1){
                        nmst = 10;
                    }
            ...
            else
                {
                    ...
                    document.getElementById("stepnum").value = parseInt(document.getElementById("stepnum").value) + 1;
                    if(document.getElementById("stepnum").value == 8){
                        nmst = document.getElementById("stepnum").value;
                ...
                // what the hell
    var getstpnm = document.getElementById("stepnum").value;

                switch(parseInt(getstpnm)){
                    case 1:
                        document.getElementById("left_form").style.backgroundColor = "#da1e28";
                        document.getElementById("pic_info").innerHTML= "Student Information";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/boy.png";
                        break;
                    case 2:
                        document.getElementById("left_form").style.backgroundColor = "#1a9a47";
                        document.getElementById("pic_info").innerHTML= "father";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/father.png";
                        break;
                    case 3:
                        document.getElementById("left_form").style.backgroundColor = "#213f95";
                        document.getElementById("pic_info").innerHTML= "mother";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/mother.png";
                        break;
                    case 4:
                        document.getElementById("left_form").style.backgroundColor = "#e7cf39";
                        document.getElementById("pic_info").innerHTML= "emergency";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/warning.png";
                        break;
                    case 5:
                        document.getElementById("left_form").style.backgroundColor = "#0e2a47";
                        document.getElementById("pic_info").innerHTML= "childern";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/boy.png";

                        break;
                    case 6:
                        document.getElementById("left_form").style.backgroundColor = "#1eacd6";
                        document.getElementById("pic_info").innerHTML= "school";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/school.png";

                        break;
                    case 7:
                        document.getElementById("left_form").style.backgroundColor = "#1a9a47";
                        document.getElementById("pic_info").innerHTML= "kidoooo";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/father.png";

                        break;
                    case 8:
                        document.getElementById("left_form").style.backgroundColor = "#1a9a47";
                        document.getElementById("pic_info").innerHTML= "sign";
                        document.getElementById("infoimg").src= "http://localhost/ndis/ndis/public/website/img/stepper/father.png";
                        break;
